...
public class Booking_Bioskop_kel7 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--------------------------------");
        System.out.println("selamat datang di pemesanan bioskop");
        ...
        if (umur < 13) {
                ...
                if (pilih == 1) {
                    ...
                    if (nomorKursi >= 1 && nomorKursi <= jumlahKursi) {
                        if (!kursiTerisi[nomorKursi - 1]) {
                            ...
                            //KEVV
                            displaySeat[counter1] = nomorKursi;
                            counter1++;
            ...
            System.out.println();
            System.out.println("=================================================");
            System.out.println(judulFilm[pilihanFilm]);
            System.out.println("=================================================");
            System.out.println("Studio " + hasil);
            System.out.println();
            for (int i = 0; i < displaySeat.length; i++) {
                System.out.print("Seat " + (i + 1) + " : No. " + displaySeat[i]);
                System.out.println();
            ...
            if (pilihan.equalsIgnoreCase("y")) {
                ...
                for (int i = 0; i < counter; i++) {
                    System.out.println(menu[displayMenu[i]] + " : " + displayJumlahMenu[i]);
                }
            } else {
